/**
 * Objet de gestion du formulaire de devis baignoire a porte.
 * @author	Camille Khalaghi <camille.khalaghi@finemedia.fr>
 * @copyright	© 2013, Fine Media
 */
formulaire.maison.baignoireAPorte = new function() {
	/**
	 * Question "prestation".
	...
	this.questPrestation = function(answer) {
		...
		$('#_form-question-prestation_baignoire-porte span._option').removeClass('selected');
		// sélectionner l'option choisie
		$("#_form-option-prestation_baignoire-porte-" + answer).addClass('selected');
		// mettre à jour la réponse à poster
		$('#_form_main-prestation_baignoire-porte').val(answer);
