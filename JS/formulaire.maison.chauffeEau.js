/**
 * Objet de gestion du formulaire de devis chauffe-eau.
 * @author	Camille Khalaghi <camille.khalaghi@finemedia.fr>
 * @copyright	© 2013, Fine Media
 */
formulaire.maison.chauffeEau = new function() {
	/**
	 * Question "prestation".
	...
	this.questPrestation = function(answer) {
		...
		$('#_form-question-prestation_chauffe-eau span._option').removeClass('selected');
		// sélectionner l'option choisie
		$("#_form-option-prestation_chauffe-eau-" + answer).addClass('selected');
		// mettre à jour la réponse à poster
		$('#_form_main-prestation_chauffe-eau').val(answer);
