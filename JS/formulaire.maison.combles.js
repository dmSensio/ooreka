 ...
 */
formulaire.maison.combles = new function() {
	/**
	 * Question "prestation".
	...
	this.questPrestation = function(answer) {
		...
		$('#_form-question-prestation_combles span._option').removeClass('selected');
		// sélectionner l'option choisie
		$("#_form-option-prestation_combles-" + answer).addClass('selected');
		// mettre à jour la réponse à poster
		$('#_form_main-prestation_combles').val(answer);
	...
	/**
	 * Question "charpente existante".
	 * @param	answer		Réponse.
	 */
	this.stepExistant = function(answer) {
		// gérer la sélection
		// désélectionner les autres options
		$('#_form-question-existant_combles span._option').removeClass('selected');
		// sélectionner l'option choisie
		$("#_form-option-existant_combles-" + answer).addClass('selected');
		// mettre à jour la réponse à poster
		$('#_form_main-existant_combles').val(answer);
		// passer à l'étape suivante
		formulaire.step.next();
	};
	/**
	 * Question "nature du plancher".
	 * @param	answer		Réponse.
	 */
	this.stepNature = function(answer) {
		// gérer la sélection
		// désélectionner les autres options
		$('#_form-question-nature_combles span._option').removeClass('selected');
		// sélectionner l'option choisie
		$("#_form-option-nature_combles-" + answer).addClass('selected');
		// mettre à jour la réponse à poster
		$('#_form_main-nature_combles').val(answer);
		// passer à l'étape suivante
		formulaire.step.next();
	};
