/**
 * Objet de gestion du formulaire de devis plancher-chauffant.
 * @author	Camille Khalaghi <camille.khalaghi@finemedia.fr>
 * @copyright	© 2013, Fine Media
 */
formulaire.maison.plancherChauffant = new function() {
	/**
	 * Question "prestation".
	...
	this.questPrestation = function(answer) {
		...
		$('#_form-question-prestation_plancher-chauffant span._option').removeClass('selected');
		// sélectionner l'option choisie
		$("#_form-option-prestation_plancher-chauffant-" + answer).addClass('selected');
		// mettre à jour la réponse à poster
		$('#_form_main-prestation_plancher-chauffant').val(answer);
