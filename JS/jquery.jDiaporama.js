		...
		this.each(function(){
			...
			if($("li", diapo).length > 1){
				...
				function init()
				{
					...
					if(options.controls)
						diapo.siblings(".jDiaporama_status").hide();
				...
				$("li:first-child", diapo).addClass("active").show();
				...
				if(options.controls)
				{
					diapo.after("<div class='jDiaporama_controls'><a href='#' class='prev'><img src='/img/dispo_fleche_g.jpg'/></a> " + ((options.auto)?"<a href='#' class='pause'>Pause</a>":"") + " <a href='#' class='next'><img src='/img/dispo_fleche_d.jpg'/></a></div>");
