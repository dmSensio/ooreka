/**
 * Objet de gestion du formulaire de devis monte-escalier.
 * @author	Dorian Yahouédéou <dorian.yahouedeou@finemedia.fr>
 * @copyright	© 2013, Fine Media
 */
formulaire.maison.monteEscalier = new function() {
	/**
	 * Question "prestation".
	...
	this.questPrestation = function(answer) {
		...
		$('#_form-question-prestation_monte-escalier span._option').removeClass('selected');
		// sélectionner l'option choisie
		$("#_form-option-prestation_monte-escalier-" + answer).addClass('selected');
		// mettre à jour la réponse à poster
		$('#_form_main-prestation_monte-escalier').val(answer);
